...
#warning "XXX: _SSE_RSqrtFast() not use rsqrtss to implement, it is implemented in c function"
	return sqrt(x)/x;
/*	
	 __asm__ __volatile__(
		"rsqrtss %1, %%xmm0 \n\t"
...
{
	Assert( s_bMathlibInitialized );
	printf("XXX: _SSE_VectorNormalize() has not ported to FreeBSD\n");	
#if 0
...
{	
	float	inv_r2 = 1.f;
	printf("XXX: _SSE_InvRSquared() has not been ported to FreeBSD\n");
#if 0	
#ifdef WIN32
