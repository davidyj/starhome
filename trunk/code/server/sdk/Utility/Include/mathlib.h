...
#define ONE_DIV_180  0.00555555555555555555555555555556f
#define ONE_DIV_PI   0.31830988618379067153803535746773f
...
{
	return MAX_VALUE( v[0], MAX_VALUE( v[1], v[2] ) );
}
...
inline void AngleQuaternion( const QAngle& angles, Quaternion &qt );
...
* 函数名称 : MatrixPosition
* 功能描述 : 位置相对矩阵变化
* 参　　数 : [in] const matrix3x4_t &matrix: 矩阵
* 参　　数 : [out] Vector &position: 变化后的位置
* 返 回 值 : void
* 作　　者 : david
* 设计日期 : 2011年1月11日
* 注    意 : * 修改日期     修改人    修改内容
...
* 函数名称 : MatrixAngles
* 功能描述 : 角度根据矩阵变化
* 参　　数 : [in] const matrix3x4_t &matrix
* 参　　数 : [out] QAngle &angles
* 返 回 值 : void
* 作　　者 : david
* 设计日期 : 2011年1月11日
* 注    意 : * 修改日期     修改人    修改内容
