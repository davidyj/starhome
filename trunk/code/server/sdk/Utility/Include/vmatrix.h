...
public:
	...
	Vector		VMul4x3ExY(const Vector &vVec,const Vector &vVecExY) const;
...
inline Vector VMatrix::VMul4x3ExY(const Vector &vVec,const Vector &vVecExY) const
{
	return Vector(
		m[0][0]*vVec.x    + m[0][1]*vVec.y    + m[0][2]*vVec.z    + m[0][3],
		m[1][0]*vVecExY.x + m[1][1]*vVecExY.y + m[1][2]*vVecExY.z + m[1][3],
		m[2][0]*vVec.x    + m[2][1]*vVec.y    + m[2][2]*vVec.z    + m[2][3]
	);
}
