...
#ifdef FREEBSD
	#include <stdarg.h>	//va_list	2010-11-19 li9chuan
#endif
...
#endif
#else
	#error Unknown compiler - I can not promise that this code will work.
	#define	DEBUG_BREAK() DebugBreak()
#endif
#else
	#define	DEBUG_BREAK() 
...
// version of C.
// these types have been defined by FreeBSD OS,added by lujd
#ifdef WIN32
