...
namespace ThreadLib
{
	...
	inline void LockedIncrement(volatile LONG *param)
	{
		InterlockedIncrement(param);
	}

	inline void LockedDecrement(volatile LONG *param)
	{
		InterlockedDecrement(param);
	}

	inline LONG LocketAdd(volatile LONG* param,LONG value)
	{
		return InterlockedExchangeAdd(param,value);
	}

	inline void LocketSet(volatile LONG* param,LONG value)
	{
		InterlockedExchange(param,value);
	}

	inline LONG LocketRead(volatile LONG* param)
	{
		return InterlockedExchangeAdd(param,0);
	}
