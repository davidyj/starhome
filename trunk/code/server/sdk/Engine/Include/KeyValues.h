...
public:
	...
	bool LoadFromLmtBuffer( CUtlBuffer &pBuffer );
	bool LoadFromLmtBuffer( const void * pBuffer,const int fileSize);
...
private:
	...
	void VmtSaveToBitFile(IBaseFileSystem *filesystem, FileHandle_t f); //by  ¶þ½øÖÆmaterial's vmt file
...
//by 
ENGINE_GLOBAL void MemScratchEngineRelease( );  //to memory clear for studio engine
