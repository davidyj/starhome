...
#include "../../Utility/Include/CommDef.h"
#include "EngineDefine.h"
#include "utlmemory.h"
#include <stdarg.h>

#include "strtools.h" // Q_strlen
...
public:
	...
	inline void	SetTextMode( bool bText ){ 
		if( bText )
			m_Flags |= TEXT_BUFFER;
		else
			m_Flags |= ~TEXT_BUFFER;
