...
public:
	...
	UtlSymId_t  AddString( char const* pStr );
	static CUtlSymbol Find( char const* pStr );
...
class ENGINE_CLASS CUtlSymbolTable
{
public:
	// constructor, destructor
...
protected:
	...
	CUtlRBTree<unsigned int, unsigned int>	m_Lookup;
