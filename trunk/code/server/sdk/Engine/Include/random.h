...
//-----------------------------------------------------------------------------
ENGINE_GLOBAL void	RandomSeed( int iSeed );
ENGINE_GLOBAL float	RandomFloat( float flMinVal = 0.0f, float flMaxVal = 1.0f );
ENGINE_GLOBAL int	RandomInt( int iMinVal, int iMaxVal );
ENGINE_GLOBAL float	RandomGaussianFloat( float flMean = 0.0f, float flStdDev = 1.0f );


//-----------------------------------------------------------------------------
// Installs a global random number generator, which will affect the Random functions above
//-----------------------------------------------------------------------------
ENGINE_GLOBAL void	InstallUniformRandomStream( IUniformRandomStream *pStream );
