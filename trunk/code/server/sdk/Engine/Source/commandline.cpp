...
CCommandLine::~CCommandLine( void )
{
	...
	SAFE_DELETE_ARRAY( m_pszCmdLine );
}
...
//-----------------------------------------------------------------------------
//modified: Jiandong Lu  2009.9.13
//以'#'字符开始的行是注释，被忽略
...
//	int nLen = (int)pLast - (int)pFirst + 1;
	int nLen = (intptr_t)pLast - (intptr_t)pFirst + 1;
