...
public class CCharecter  {	
	...
	public void init() {	
		...
		//body 24 * 29
		CCharacterPart bodySprite1 = CCharacterPart.create("img/character/00002000/alert.0.body.png");
		...
		// 24 * 31
		CCharacterPart bodySprite3 = CCharacterPart.create("img/character/00002000/alert.2.body.png");
		...
		//arm 8 * 14
		CCharacterPart armSprite1 = CCharacterPart.create("img/character/00002000/alert.0.arm.png");
		...
		CCharacterPart lhandSprite2 = CCharacterPart.create("img/character/00002000/alert.1.lhand.png");
		...
		CCharacterPart lhandSprite3 = CCharacterPart.create("img/character/00002000/alert.2.lhand.png");
		...
		CCharacterFrame frames1 = CCharacterFrame.create();
		frames1.addSprites(sprites1);
		CCharacterFrame frames2 = CCharacterFrame.create();
		frames2.addSprites(sprites2);
		CCharacterFrame frames3 = CCharacterFrame.create();
		frames3.addSprites(sprites3);	
		
		//animation
		CCharacterAnimation animation = CCharacterAnimation.create();
